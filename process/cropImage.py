...
def cropImage(outputs, im):
    ...
    img_detection = img_crop_array[score_hight] #cv2.cvtColor(img_crop_array[score_hight], cv2.COLOR_BGR2RGB)

    # score_detection = score_array[score_hight]
